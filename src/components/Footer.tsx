    ...
    <footer className="bg-secondary text-secondary-foreground mt-20">
      <div className="container px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-secondary-foreground/80 leading-relaxed">
              A coordinated ecosystem dedicated to public benefit, life-saving innovation, 
        ...
        <div className="border-t border-secondary-foreground/20 pt-8 text-center text-sm text-secondary-foreground/70">
          <p className="mb-2">
            © {new Date().getFullYear()} Lifesaver Labs PBC & Coalition. 
            A public benefit organization committed to life-saving innovation.
          </p>
          <p className="italic">
            "First, do no harm. Then, save lives."
          </p>
        </div>
      </div>
    </footer>
