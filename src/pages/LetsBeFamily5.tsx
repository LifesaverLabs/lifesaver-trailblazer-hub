  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container px-6">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-bold text-foreground">The Loneliness We Can Fix</h2>
            </div>

            <div className="prose prose-lg max-w-none text-muted-foreground leading-relaxed space-y-6">
              <p className="text-xl">
                Since Robert Putnam's groundbreaking book <em className="text-foreground font-medium">Bowling Alone</em>{" "}
                (2000), we've known that our societies are becoming more lonely and isolating. Social capital—the
                connections between individuals, the networks of trust and reciprocity—has been declining for decades.
              </p>
              ...
              <Card className="bg-primary/5 border-primary/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground">
                    Studies show chronic loneliness can be as harmful to health as smoking 15 cigarettes a day. Yet
                    every day, millions of us sit in restaurants, cafés, and public spaces—surrounded by potential
                    friends, kousins, and kindred spirits—in silence.
                  </p>
                </CardContent>
              </Card>

              <p className="text-xl">
                <strong className="text-foreground">But here's the beautiful truth:</strong> This is an epidemic we can
                fix with nothing more than a simple signal—a table tent, a card, a small gesture that says:
              </p>
        ...
        <div className="container px-6">
          <div className="max-w-5xl mx-auto">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-bold text-foreground">The Table Tent Revolution</h2>
            </div>

            <p className="text-xl text-muted-foreground text-center max-w-3xl mx-auto mb-12">
              Imagine a simple, beautifully designed table tent that invites fellow kousins to join your conversation
              across the Family⁵.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <Card className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30 border-primary/20 hover:shadow-lg transition-shadow">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-display font-bold text-foreground mb-3">For Diners & Café Patrons</h3>
              ...
              <Card className="bg-gradient-to-br from-rose-50 to-pink-50 dark:from-rose-950/30 dark:to-pink-950/30 border-primary/20 hover:shadow-lg transition-shadow">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-display font-bold text-foreground mb-3">For Restaurant & Café Owners</h3>
                  <ul className="space-y-2 text-muted-foreground">
                    <li>• Stock table tents for patrons to use</li>
                    <li>• Signal that your space welcomes calmunity⁵</li>
            ...
            <Card className="bg-primary/10 border-primary/30">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  Especially while traveling, getting to know a new place, or when wanting a change of pace from typical
                  intimate family⁵ conversations to larger Family⁵ conversations with our kousins.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-bold text-foreground">Download & Print</h2>
            </div>

            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              We're building a growing gallery of beautiful table tent designs. Download, print on cardstock, laminate
              if you can, and start sparking Family⁵ conversations.
            </p>
                ...
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 flex flex-col justify-center">
                    ...
                    <p className="text-muted-foreground mb-6 text-sm">
                      A conversation-starting table tent with QR code. Print on cardstock, fold, and place on your table
                      to invite deeper conversations with fellow kousins.
                    </p>
                    <a
              ...
              <CardContent className="p-0">
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 flex flex-col justify-center">
                    ...
                    <h3 className="text-2xl font-display font-bold text-foreground mb-3">
                      "Heads Down Mode" Display <span className="text-sm font-normal text-muted-foreground">v0.0.3</span>
                    </h3>
                    <p className="text-muted-foreground mb-2">
            ...
            <Card className="bg-muted/30 border-dashed border-2 border-muted-foreground/20 mb-8">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  More designs coming soon! We're building a growing gallery of table tents for different moods and
                  conversation styles.
                </p>
              </CardContent>
            </Card>
            ...
            <p className="text-muted-foreground text-sm">
              <strong>Pro tip:</strong> Print on cardstock and laminate for durability. Fold into a tent shape so both
              sides are visible!
            </p>
          </div>
        </div>
        ...
        <div className="container px-6">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-bold text-foreground">Free to Remix & Share</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="bg-card">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground mb-4">
                    ...
                    <strong className="text-foreground"> CC0 1.0 Universal</strong> license— dedicated to the public
                    domain for free creative remixing.
                  </p>
              ...
              <Card className="bg-card">
                <CardContent className="p-8">
                  <h3 className="text-xl font-display font-bold text-foreground mb-4">Branch, Create, Share Back</h3>
                  <p className="text-muted-foreground mb-4">
                    We encourage you to branch these designs and develop even better galleries. Create designs that
                    speak to your local culture, language, or community.
                  </p>
                  <p className="text-muted-foreground mb-4">
                  ...
                  <p className="text-sm text-muted-foreground mt-2">We'd love to study and feature your designs!</p>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary via-orange-500 to-rose-500 text-white">
        <div className="container px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-6">A Message to Social Spaces Everywhere</h2>

            <p className="text-xl text-white/95 mb-8 leading-relaxed max-w-3xl mx-auto">
              Restaurant and café owners, pub keepers, co-working spaces, hotel lounges, airport terminals— any place
              where strangers gather and could become kloser kousins:
            </p>

            <Card className="bg-white/10 backdrop-blur-sm border-white/20 mb-8">
              <CardContent className="p-8">
                <p className="text-2xl font-display font-medium text-white leading-relaxed">
                  Print and stock designs like these as a welcome sign that you encourage conversations across families.
                  You're not just serving food—you're serving community.
                </p>
              </CardContent>
            </Card>

            <p className="text-white/90 text-lg">
              Every table tent placed is a small vote for a more connected world. It could do tremendous wonders for
              American and All-Nation internal and cross-coupled social capital ⇋ capitol.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-background">
        <div className="container px-6">
          <div className="max-w-3xl mx-auto text-center">
            <blockquote className="mb-8 p-6 bg-muted/30 rounded-lg border border-border">
              <p className="text-2xl md:text-3xl font-display text-foreground leading-relaxed mb-3" dir="rtl" lang="he">
                הִנֵּה מַה־טּוֹב וּמַה־נָּעִים שֶׁבֶת אַחִים גַּם־יָחַד
              </p>
              <p className="text-lg md:text-xl text-muted-foreground italic">
                "Behold, how good and how pleasant it is when brothers and kousins dwell together in unity⁵."
              </p>
              <footer className="text-sm text-muted-foreground/70 mt-3">— Psalm 133:1</footer>
            </blockquote>
            
            <p className="text-2xl md:text-3xl font-display text-foreground leading-relaxed">
              In a world that's been <em>Bowling Alone</em> for too long, let's start{" "}
              <strong className="text-primary">Sitting Together</strong>.
            </p>
            <p className="text-lg text-muted-foreground mt-6">Come sit. Let's be Family⁵.</p>
          </div>
        </div>
      </section>
